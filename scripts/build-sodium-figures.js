...
// docs/sodium-figures.md. Run from anywhere:
...
// Figure number -> what the diagram shows. Descriptions are read off the book's
// figures themselves, not from its prose.
const FIGURES = [
  [
    'fig01',
...
const main = async () => {
  ...
  for (const [name, description] of FIGURES) {
